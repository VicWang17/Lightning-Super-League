...
*   **联赛体系结构**：
    ...
    *   **三级联赛（3级）**：2个平行联赛（3A和3B），每个联赛8支球队，新手和弱势玩家的起始舞台。
    *   **总计**：4个联赛，32支球队。
*   **升降级规则**：
    *   **顶级联赛 ↔ 次级联赛**：
        *   顶级联赛后2名降级至次级联赛。
        *   次级联赛前2名升级至顶级联赛。
        *   *后续扩展：第三名之间可能进行附加赛决定升降级资格。*
    *   **次级联赛 ↔ 三级联赛**：
        *   次级联赛后2名降级至三级联赛（根据地理位置或随机分配至3A或3B）。
        *   两个三级联赛的冠军各获得1个升级名额，共2个名额升级至次级联赛。
*   **积分与排名规则**：
    *   胜场得3分，平局得1分，负场得0分。
...
*   **比赛频率与赛程**：
    *   **比赛间隔**：平均两天进行一场比赛。
    *   **单赛季场次**：每支球队单赛季进行14场比赛（双循环，7个对手×2）。
    *   **赛季总比赛数**：4个联赛共进行112场比赛（14场×8支球队÷2）。
*   **定时调度系统**：
    *   **赛程生成**：赛季开始前自动生成完整的赛程表，确保主客场平衡。
