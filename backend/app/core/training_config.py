...
# ----- 9.8 门将训练 -----
_register(TrainingItem("gk_set_position", "准备姿势与重心", "goalkeeper", "门将组", 0.05, "normal", -4, 4, 2,
    {"pos": 0.90, "ref": 0.50, "bal": 0.25, "com": 0.20},
    {"FW": 0.20, "MF": 0.20, "DF": 0.30, "GK": 1.15}, wear_impact={"knee": 1, "ankle": 1}))
_register(TrainingItem("gk_low_save", "低平球扑救", "goalkeeper", "门将组", 0.05, "normal", -4, 4, 2,
    {"sav": 0.90, "ref": 0.50, "pos": 0.25},
    {"FW": 0.20, "MF": 0.20, "DF": 0.30, "GK": 1.15}, wear_impact={"shoulder": 2, "knee": 2, "back": 1}))
_register(TrainingItem("gk_close_range", "近距离封堵", "goalkeeper", "门将组", 0.06, "hard", -6, 7, 3,
    {"ref": 0.80, "sav": 0.70, "com": 0.30, "rus": 0.25},
    {"FW": 0.20, "MF": 0.20, "DF": 0.30, "GK": 1.15}, wear_impact={"shoulder": 3, "knee": 3, "fingers": 2, "back": 2}))
_register(TrainingItem("gk_cross_claim", "传中球摘取", "goalkeeper", "门将组", 0.05, "normal", -4, 4, 2,
    {"rus": 0.80, "pos": 0.50, "com": 0.30, "hea": 0.20},
    {"FW": 0.20, "MF": 0.20, "DF": 0.30, "GK": 1.15}, wear_impact={"shoulder": 2, "back": 2, "knee": 2, "fingers": 1}))
_register(TrainingItem("gk_one_v_one", "单刀出击", "goalkeeper", "门将组", 0.06, "hard", -6, 7, 3,
    {"rus": 0.80, "com": 0.50, "ref": 0.40, "dec": 0.25},
    {"FW": 0.20, "MF": 0.20, "DF": 0.30, "GK": 1.15}, wear_impact={"knee": 3, "ankle": 3, "shoulder": 2, "back": 2}))
_register(TrainingItem("gk_distribution_short", "短传出球", "goalkeeper", "门将组", 0.04, "light", -2, 2, 1,
    {"pas": 0.70, "com": 0.40, "dec": 0.25, "con": 0.20},
    {"FW": 0.20, "MF": 0.30, "DF": 0.40, "GK": 1.10}, wear_impact={"shoulder": 1}))
_register(TrainingItem("gk_distribution_long", "长距离开球", "goalkeeper", "门将组", 0.04, "normal", -4, 4, 2,
    {"pas": 0.80, "str_": 0.30, "dec": 0.25},
    {"FW": 0.20, "MF": 0.30, "DF": 0.40, "GK": 1.10}, wear_impact={"shoulder": 2, "back": 2, "groin": 1}))
_register(TrainingItem("gk_penalty_read", "点球方向读取", "goalkeeper", "门将组", 0.04, "light", -2, 2, 1,
    {"ref": 0.70, "com": 0.50, "sav": 0.40, "dec": 0.25},
    {"FW": 0.20, "MF": 0.20, "DF": 0.30, "GK": 1.15}, wear_impact={"shoulder": 1}))

# ----- 9.9 比赛经验 -----
# 虚拟训练项：上场比赛后自动结算，玩家不可手动选择
_register(TrainingItem("match_experience", "比赛实战经验", "match", "全队", 0.04, "normal", 0, 0, 0,
    {"sho": 0.25, "pas": 0.25, "dri": 0.20, "spd": 0.20, "str_": 0.15, "sta": 0.30,
     "acc": 0.20, "hea": 0.15, "bal": 0.20, "defe": 0.20, "tkl": 0.15, "vis": 0.20,
     "cro": 0.10, "con": 0.20, "fin": 0.15, "com": 0.15, "sav": 0.10, "ref": 0.15,
     "pos": 0.15, "rus": 0.10, "dec": 0.25, "fk": 0.05, "pk": 0.10},
    {"FW": 1.00, "MF": 1.00, "DF": 1.00, "GK": 1.00}))

# ----- 9.10 恢复与分析 -----
_register(TrainingItem("full_rest", "完全休息", "recovery", "全队", 0.0, "light", 14, -24, -2,
    {}, {}, is_recovery=True))
_register(TrainingItem("mobility_session", "活动度与拉伸", "recovery", "全队", 0.02, "light", 6, -9, 0,
    {"bal": 0.30}, {}, is_recovery=True))
_register(TrainingItem("recovery_bike", "低强度单车恢复", "recovery", "全队/指定球员", 0.02, "light", 8, -12, -1,
    {"sta": 0.25}, {}, is_recovery=True))
_register(TrainingItem("hydro_recovery", "水疗恢复", "recovery", "全队/指定球员", 0.0, "light", 10, -18, -1,
    {}, {}, is_recovery=True))
_register(TrainingItem("individual_treatment", "个人理疗", "recovery", "指定球员", 0.0, "light", 12, -21, -2,
    {}, {}, is_recovery=True))
_register(TrainingItem("match_review_unit", "分组录像复盘", "analysis", "分组", 0.03, "light", 2, -3, 0,
    {"dec": 0.50, "vis": 0.30}, {}, is_recovery=True))
_register(TrainingItem("opponent_clip_study", "对手片段研究", "analysis", "全队/分组", 0.02, "light", 2, -3, 0,
    {"dec": 0.40}, {}, is_recovery=True))
_register(TrainingItem("role_meeting", "位置职责会议", "analysis", "分组", 0.02, "light", 2, -3, 0,
    {"dec": 0.40, "com": 0.20}, {}, is_recovery=True))
_register(TrainingItem("captain_meeting", "队长沟通会", "analysis", "全队", 0.01, "light", 2, -3, 0,
...
class TrainingTemplate:
    ...
    name: str
    description: str
    schedule: list[list[str]]  # 7天 x 最多3时段的训练项ID；比赛日只有上午+下午2个时段，第3项自动跳过
