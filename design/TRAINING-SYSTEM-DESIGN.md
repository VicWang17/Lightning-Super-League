...
| 年龄段 | 早熟 | 平稳 | 晚熟 |
| --- | --- | --- | --- |
| 16-18 | 1.20 | 0.90 | 0.65 |
| 19-21 | 1.35 | 1.10 | 0.80 |
| 22-24 | 1.10 | 1.20 | 0.95 |
| 25-27 | 0.75 | 1.15 | 1.10 |
| 28-30 | 0.35 | 0.85 | 1.25 |
| 31-32 | 0.10 | 0.45 | 1.10 |
| 33+ | 0.00 | 0.10 | 0.35 |
...
| `age_factor` | 0.00-1.35 | 成长曲线决定。 |
| `growth_speed` | 0.70-1.30 | 球员隐藏成长速度。 |
| `potential_factor` | 0.00-1.00 | 越接近上限越低。 |
...
potential_factor = clamp(remaining / 4.0, 0.05, 1.0)
```

当只剩 `0.2` 上限空间时：

```
potential_factor = 0.05
```
