	...
	req := domain.SimulateRequest{
		HomeTeam: domain.TeamSetup{
			...
			Players: []domain.PlayerSetup{
				...
				{PlayerID: "h2", Name: "DF", Position: "DF", Attributes: map[string]int{"SHO":10,"PAS":10,"DRI":10,"SPD":10,"STR":14,"STA":10,"DEF":16,"HEA":15,"VIS":10,"TKL":13,"ACC":10,"CRO":10,"CON":10,"FIN":10,"BAL":10,"COM":10,"SAV":10,"REF":10,"POS":10,"SET":10}, Skills: []string{}, Stamina: 100, Height: 185, Foot: "right"},
			},
		...
		AwayTeam: domain.TeamSetup{
			...
			Players: []domain.PlayerSetup{
				...
				{PlayerID: "a2", Name: "DF", Position: "DF", Attributes: map[string]int{"SHO":10,"PAS":10,"DRI":10,"SPD":10,"STR":14,"STA":10,"DEF":16,"HEA":15,"VIS":10,"TKL":13,"ACC":10,"CRO":10,"CON":10,"FIN":10,"BAL":10,"COM":10,"SAV":10,"REF":10,"POS":10,"SET":10}, Skills: []string{}, Stamina: 100, Height: 185, Foot: "right"},
			},
