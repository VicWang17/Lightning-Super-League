...
export const AWARD_COLORS: Record<AwardType, string> = {
  match_mvp: 'text-[#C77A00]',
  league_team_of_season: 'text-[#1F5F43]',
  league_best_fw: 'text-[#FF6F59]',
  league_best_mf: 'text-[#1F5F43]',
  league_best_df: 'text-[#1F5F43]',
  league_best_gk: 'text-[#C77A00]',
  league_golden_boot: 'text-[#C77A00]',
  league_playmaker: 'text-[#1F5F43]',
  league_golden_glove: 'text-[#59C7EE]',
  league_golden_wall: 'text-[#FF6F59]',
  cup_golden_boot: 'text-[#C77A00]',
  cup_playmaker: 'text-[#1F5F43]',
  cup_golden_glove: 'text-[#59C7EE]',
  cup_golden_wall: 'text-[#FF6F59]',
  season_best_player: 'text-[#1F5F43]',
  season_best_fw: 'text-[#FF6F59]',
  season_best_mf: 'text-[#1F5F43]',
  season_best_df: 'text-[#1F5F43]',
  season_best_gk: 'text-[#C77A00]',
  season_golden_boot: 'text-[#C77A00]',
  season_playmaker: 'text-[#1F5F43]',
  season_golden_glove: 'text-[#59C7EE]',
  season_golden_wall: 'text-[#FF6F59]',
}
