...
def _reset_unversioned_dev_schema() -> None:
    """Clear an old dev schema before applying the first Alembic revision."""
    ...
    current_revision = conn.execute(text("""
        ...
        LIMIT 1
    """)).scalar() if _table_exists(conn, "alembic_version") else None
    if current_revision:
        return
